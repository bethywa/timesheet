...
const API_URL = "http://172.16.29.163:8080/api/kpireports";
  ...
  actions: {
    ...
    async fetchKPIData() {
      ...
      try {
        ...
        const response = await apiService.all("kpi-reports");
        const data = response.data;

        // Update KPI data
        this.kpiData = data.kpis || [];

        // Update chart data (ensure labels and datasets are always defined)
